...
import { Workspace, WorkspaceDetail, WorkspaceInvitation, WorkspaceInvitationListResponse, WorkspaceMember, WorkspaceMemberDetail, WorkspaceMembersResponse } from '@/types/workspace.type';
...
export const workspaceApi = {
    ...
    */
    ...
    getAllMembers(workspaceId: string, page?: number, limit?: number, search?: string) {
        ...
        return api.get<ApiResponse<WorkspaceMembersResponse>>(`${PREFIX}/workspaces/${workspaceId}/members?page=${page || 1}&limit=${limit || 10}${searchParam}`);
    },
    ...
    getMemberById(workspaceId: string, memberId: string) {
        return api.get<ApiResponse<WorkspaceMemberDetail>>(`${PREFIX}/workspaces/${workspaceId}/members/${memberId}`);
    },
    ...
    transferOwnership(workspaceId: string, newOwnerId: string) {
        return api.patch<ApiResponse<null>>(`${PREFIX}/workspaces/${workspaceId}/members/ownership`, { newOwnerId });
    },
    ...
    updateMemberRole(workspaceId: string, memberId: string, newRoleId: string) {
        return api.patch<ApiResponse<WorkspaceMemberDetail>>(`${PREFIX}/workspaces/${workspaceId}/members/${memberId}`, { newRoleId });
    },
    ...
    inviteMember(workspaceId: string, data: { email: string; roleId: string }) {
        return api.post<ApiResponse<WorkspaceInvitation>>(`${PREFIX}/workspaces/${workspaceId}/invitations`, data);
    },
    ...
    getAllInvitations(workspaceId: string, page: number, limit: number, search?: string) {
        const searchParam = search ? `&search=${search}` : '';
        return api.get<ApiResponse<WorkspaceInvitationListResponse>>(`${PREFIX}/workspaces/${workspaceId}/invitations?page=${page}&limit=${limit}${searchParam}`);
    },
    ...
    getInvitationById(workspaceId: string, invitationId: string) {
        return api.get<ApiResponse<WorkspaceInvitation>>(`${PREFIX}/workspaces/${workspaceId}/invitations/${invitationId}`);
    },
    ...
    acceptInvitation(workspaceId: string, invitationId: string, token: string) {
        return api.get<ApiResponse<WorkspaceInvitation>>(`${PREFIX}/workspaces/${workspaceId}/invitations/${invitationId}/accept?token=${token}`);
    },
    ...
    validateInvitation(workspaceId: string, token: string) {
        return api.get<ApiResponse<WorkspaceInvitation>>(`${PREFIX}/workspaces/${workspaceId}/invitations/validate?token=${token}`);
    },
    ...
    declineInvitation(workspaceId: string, token: string) {
        return api.get<ApiResponse<null>>(`${PREFIX}/workspaces/${workspaceId}/invitations/reject?token=${token}`);
    },
    ...
    revokeInvitation(workspaceId: string, invitationId: string) {
        return api.delete<ApiResponse<null>>(`${PREFIX}/workspaces/${workspaceId}/invitations/${invitationId}`);
    },
