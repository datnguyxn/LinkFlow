...
export default function WorkspaceSettingsHeader({ workspace }: { workspace: WorkspaceDetail }) {
  return (
    <div
      className="
        border-b
      ...
      <div className="mx-auto max-w-5xl p-6 lg:p-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">Manage settings for {workspace.name}</p>
          </div>
        </div>
      </div>
    </div>
