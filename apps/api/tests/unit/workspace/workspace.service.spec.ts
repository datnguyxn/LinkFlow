...
describe('WorkspaceService', () => {
  ...
  describe('getAllWorkspaces', () => {
    it('should return all user workspaces successfully', async () => {
      ...
      fixture.workspaceRepository.findAllByUserId.mockResolvedValue(workspaces);

      const result = await fixture.workspaceService.getAllWorkspaces('user-1');

      expect(result).toEqual(workspaces);

      expect(fixture.workspaceRepository.findAllByUserId).toHaveBeenCalledWith('user-1');
    });
    ...
    it('should propagate repository errors', async () => {
      ...
      await expect(fixture.workspaceService.getAllWorkspaces('user-1')).rejects.toThrow(
        'Database error',
      );
    });
  });
  ...
  describe('deleteWorkspace', () => {
    ...
    it('should delete workspace successfully', async () => {
      ...
      fixture.workspaceRepository.update.mockResolvedValue(deletedWorkspace);
    ...
    it('should throw when user is not the owner', async () => {
      fixture.workspaceRepository.findById.mockResolvedValueOnce(workspace).mockResolvedValueOnce({
        ...workspace,
