...
export class NotificationWorker {
    ...
    async handleInvitationCreated(
        ...
        console.log(`Notification created and published for workspace invitation: ${event.invitationId}`);
    }

    async handleInvitationUpdated(
        ...
        await this.redisPublisher.publish(
            REDIS_CHANNEL.NOTIFICATION_UPDATED,
            {
                userId: event.inviterId,
        ...
        console.log(`Notification created and published for workspace invitation update: ${event.invitationId}`);
    }
}