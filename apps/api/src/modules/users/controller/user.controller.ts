...
export class UserController {
    ...
    async getMyProfile(request: FastifyRequest, reply: FastifyReply) {
        ...
        return ResponseHandler.success(reply, UserSerializer.serialize(user), request.t("user.userFetchedSuccessfully"));
    }
     ...
     */
    async updateProfile(request: FastifyRequest<{ Body: Prisma.UserUpdateInput }>, reply: FastifyReply) {
        const id = request.user.id;
    ...
    */
    ...
    async changePassword(request: FastifyRequest<{ Body: { oldPassword: string; newPassword: string } }>, reply: FastifyReply) {
        ...
        return ResponseHandler.success(reply, updatedUser, request.t("user.passwordChangedSuccessfully"));
    }
}