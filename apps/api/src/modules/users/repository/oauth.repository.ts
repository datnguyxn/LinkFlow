...
export class OAuthRepository {
   ...
   */
  async findByProvider(provider: OAuthProvider, providerAccountId: string) {
   ...
   */
  async create(data: Prisma.OAuthAccountCreateInput, tx?: Prisma.TransactionClient) {
   ...
   */
  async update(id: string, data: Prisma.OAuthAccountUpdateInput, tx?: Prisma.TransactionClient) {
    // Use the provided transaction client or the default Prisma client
    const db = tx ?? prisma;
   ...
   */
  async exists(provider: OAuthProvider, providerAccountId: string) {
  ...
  async findGoogleAccount(providerAccountId: string) {
    ...
    return this.findByProvider(OAuthProvider.GOOGLE, providerAccountId);
  }
}
