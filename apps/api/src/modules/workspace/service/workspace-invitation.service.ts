...
export class WorkspaceInvitationService {
    ...
    constructor(
        ...
        private workspaceInvitationPublisher: WorkspaceInvitationPublisher = new WorkspaceInvitationPublisher(new Publisher()),
    ...
    async createInvitation(
        ...
        const existingInvitation = await this.workspaceInvitationRepository.findPendingByEmail(workspaceId, input.email);
    ...
    async acceptInvitation(
                        ...
                        await this.workspaceMemberRepository.create(
                            {
                                ...
                                status:
                                    WorkspaceMemberStatus.ACTIVE, // Set the status of the new workspace member to ACTIVE
                            },
                            tx,
                        );
        ...
        await this.workspaceInvitationPublisher
            .workspaceInvitationAccepted(event);
     ...
     */
    private async validateInvitationForAccept(
        token: string,
    ) {
    ...
    async revokeInvitation(
        ...
        await this.workspaceInvitationPublisher
            .workspaceInvitationRevoked(event);
    ...
    async rejectInvitation(
        ...
        await this.workspaceInvitationPublisher
            .workspaceInvitationRejected(event);
