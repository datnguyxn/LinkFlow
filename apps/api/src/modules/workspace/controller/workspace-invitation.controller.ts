...
export class WorkspaceInvitationController {
  ...
  async createInvitation(
    ...
    if (!invitation) {
      return ResponseHandler.error(
        ...
        'workspace.invitationCreationFailed',
      );
    }
  ...
  async acceptInvitation(
    ...
    if (!result) {
      return ResponseHandler.error(
        reply,
        HTTP_STATUS.BAD_REQUEST,
        'workspace.invitationAcceptanceFailed',
      );
    }
  ...
  async validateInvitation(
    ...
    if (!result) {
      return ResponseHandler.error(
        reply,
        HTTP_STATUS.BAD_REQUEST,
        'workspace.invitationValidationFailed',
      );
    }
  ...
  async revokeInvitation(
    ...
    if (!result) {
      return ResponseHandler.error(
        reply,
        HTTP_STATUS.BAD_REQUEST,
        'workspace.invitationRevocationFailed',
      );
    }
  ...
  async rejectInvitation(
    ...
    const result = await this.workspaceInvitationService.rejectInvitation(token, ipAddress);
    ...
    if (!result) {
      return ResponseHandler.error(
        reply,
        HTTP_STATUS.BAD_REQUEST,
        'workspace.invitationRejectionFailed',
      );
    }
